...
st.title("""PLANT DISEASE PREDICTION USING LEAF IMAGES""")
st.write("""THIS MODEL HELPS TO PREDICT 33 DIFFERENT LEAF DISEASES IN PLANTS""")

st.write("Please input only leaf Images of Apple, Cherry, Corn, Grape, Peach, Pepper, Potato, Strawberry, and Tomato.")
